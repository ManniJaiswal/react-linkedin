                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className="rounded-xl p-4 shadow-lg bg-white">
                        <div className="flex items-start gap-3">
                            ...
                            <input name="content" value={formik.values.content} onChange={formik.handleChange} className="flex w-full border border-gray-300 px-3 py-2 text-base shadow-sm disabled-opacity-50 md:text-sm min-h-[60px] resize-none rounded-2xl bg-gray-100 focus:border-blue-500 outline-none" placeholder="What's on your mind, Alex?"></input>
                        </div>
                        <div className="">
                            <input name="image" value={formik.values.image} onChange={formik.handleChange} type="text" placeholder="Enter image URL" className="border w-full border-gray-300 px-3 py-1 rounded-xl mt-2 bg-gray-100 text-base shadow-sm focus:border-blue-500 outline-none" />
                        </div>
